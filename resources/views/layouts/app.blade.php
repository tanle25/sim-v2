                        ...
                        <li class="flex items-center">
                            ...
                            <div class="relative text-white" x-data="{ isOpen: false}">
                                ...
                                >
                                    ...
                                    <span class="hidden sm:inline text-white ml-3 font-medium">{{Auth::user()->name}}</span>
                                ...
                                <ul x-show="isOpen"
                                    ...
                                    class="absolute font-normal text-gray-600 bg-white shadow overflow-hidden rounded w-48 border mt-2 py-1 right-0 z-20"
                                >
                                    {{-- <li>
                                    ...
                                    <li>
                                        <a href="{{url('dang-xuat')}}" class="flex items-center px-3 py-3 hover:bg-gray-200">
