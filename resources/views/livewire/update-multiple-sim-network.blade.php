        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-6 text-center">
                <form wire:submit.prevent='submit'>
                    <h3 class=" text-lg font-normal text-gray-500 dark:text-gray-400">Cập nhật nhà mạng sim hàng loạt</h3>

                    <div class=" my-5">
                        @error('network') <span class=" text-red-500 text-sm">{{$message}}</span> @enderror
                        <select wire:model='network' class=" px-3 py-2.5 w-full border border-gray-200 rounded" >
