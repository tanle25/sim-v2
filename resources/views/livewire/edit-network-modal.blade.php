        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <form wire:submit.prevent='submit'>
                <div class="p-6 text-center">
                    ...
                    <h3 class="text-lg font-normal text-gray-500 dark:text-gray-400">Thêm nhà mạng</h3>

                    <div class=" text-left my-5">
                        <label for="">Tên nhà mạng</label>
                        <div class="">
                            @error('name') <span class=" text-red-500 text-sm">{{$message}}</span> @enderror
                        </div>
                        <input wire:model.lazy='name' type="text" class="px-3 py-2.5 border border-gray-200  w-full rounded" placeholder="Tên nhà mạng">
                    </div>
