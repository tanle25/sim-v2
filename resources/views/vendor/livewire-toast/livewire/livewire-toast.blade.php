<div class="fixed {{$positionCss}} @if($hideOnClick) cursor-pointer z-40 @endif"
...
>
    @if($message)
        <div class="flex bg-{{$bgColorCss}}-600 border-l-4 border-{{$bgColorCss}}-700 py-2 px-3 shadow-md mb-2 ">
            <!-- icons -->
            @if($showIcon)
                <div class="text-{{$bgColorCss}}-600 rounded-full bg-{{$textColorCss}} mr-3">
